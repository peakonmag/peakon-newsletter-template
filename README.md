...
> 저장소 배포자 확인: 공개 전 아래 링크의 `{{NOTION_TEMPLATE_URL}}`을 실제
> Notion 공개 복제 링크로 교체해야 해요.

[Notion 뉴스 수집 대시보드 복제하기]({{https://app.notion.com/p/PEAKON-3acaafd5210e8088a695ce265980526b?source=copy_link}})
